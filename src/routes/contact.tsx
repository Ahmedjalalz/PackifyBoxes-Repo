...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://packifyboxes.com/contact" },
      { property: "og:image", content: "/packify-icon-OG.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Contact PackifyBoxes" },
      { name: "twitter:description", content: "Get in touch with PackifyBoxes for custom packaging consultations, samples and quotes. Our team replies within 24 hours." },
