...
export const Route = createFileRoute("/quote")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://packifyboxes.com/quote" },
      { property: "og:image", content: "/packify-icon-OG.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Request a Quote — PackifyBoxes" },
      { name: "twitter:description", content: "Get a free, tailored quote for your custom packaging project. Reply within 24 hours with samples, materials and pricing." },
