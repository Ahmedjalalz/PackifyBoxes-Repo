  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: product ? `https://packifyboxes.com/products/${product.slug}` : "https://packifyboxes.com/products" },
        { property: "og:image" as const, content: product?.featured_image || "/packify-icon-OG.png" },
        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:title", content: product?.title ?? "Product" },
        { name: "twitter:description", content: product?.short_description ?? "Premium custom packaging product." },
        { name: "twitter:image", content: product?.featured_image || "/packify-icon-OG.png" },
      ],
