...
export const Route = createFileRoute("/products")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://packifyboxes.com/products" },
      { property: "og:image", content: "/packify-icon-OG.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Products — Custom Packaging Boxes | PackifyBoxes" },
      { name: "twitter:description", content: "Explore premium custom packaging products with modern materials, box styles, and dynamic content sections." },
