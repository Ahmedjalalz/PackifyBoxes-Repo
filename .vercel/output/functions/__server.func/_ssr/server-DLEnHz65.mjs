...
import { j as defineHandlerCallback, J as resolveManifestAssetLink, K as resolveManifestCssLink, p as getManifestScriptFormat, L as rootRouteId, q as getNormalizedURL, r as getOrigin, c as attachRouterServerSsrUtils, g as createSerializationAdapter, f as createRawStreamRPCPlugin, w as invariant, z as isNotFound, A as isRedirect, C as isResolvedRedirect, F as mergeHeaders, m as executeRewriteInput, i as defaultSerovalPlugins, E as makeSerovalPlugin, s as getScriptPreloadAttrs, u as getStylesheetHref, H as parseRedirect } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CT4EYJtS.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C6I0yXNU.mjs").then((n) => n.r),
    import("./start-Dj2Cq5A3.mjs"),
